...
from <span class="goog_qs-tidbit goog_qs-tidbit-0">matplotlib.figure import Figure
import matplotlib.pyplot as plt

# data logger window #
class</span> DataLoggerWindow(wx.Frame):
    '''
    Creates data logger window.
    '''
    def __init__(self):
        wx.Frame.__init__(self, None, -1, 'data logger', (100,100), (640,480))
